...
describe("handlers", function() {
  ...
  describe("cacheSet", function() {
    beforeEach("setup cacheSet tests", function() {
    ...
    it("PUT - should send 200 response on success", function() {
      ...
      handlers.cacheSet(mockRequest, mockResponse);
